...
\*\*Run: $env:QUARTO_MARIMO_VERSION="0.14.6"; quarto preview 11. You can explore your website and make any other needed changes. 12. Now push your changes to Github and then go to `settings > pages` to fix how our site is rendered using [Github pages](https://quarto.org/docs/publishing/github-pages.html). We want to use the `docs` folder method.

New Stuff
(Get-Content new_post.sh -Raw) -replace "`r`n", "`n" | Set-Content new_post.sh -NoNewline
bash ./new_post.sh test "Test Marimo Post" "J. Hathaway"
